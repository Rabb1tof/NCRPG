...
#define ThisSkillShortName "frostnade"
#define VERSION				"1.4"
...
bool cfg_bSound; bool cfg_bFreeze; bool cfg_bSumm; bool cfg_bFrozenRest; bool cfg_bStatTime;
bool cfg_bEffects;
...
public Plugin myinfo = {
	name		= "NCRPG Skill Frost Nade",
	author		= "SenatoR",
	description	= "Skill Frost Nade for NCRPG",
	version		= VERSION
};
...
public void OnMapStart() {
	...
	RPG_Configs.GetString(ThisSkillShortName,"weapons",source, sizeof source, "weapon_hegrenade,weapon_flashbang,weapon_smokegrenade");
		...
		if(inflictor > MaxClients)
		{
			...
			if(StrEqual(buffer, "hegrenade_projectile"))
				if(level > 0)
				{
					...
					{
						NCRPG_SlowPlayer(victim, cfg_fSlow*level, time);
					}
